...
def permite_entrada(
    ...
    """
    Replica la logica SHORT principal:
    - requiere senal short confirmada
    - respeta bloqueo tras salida
    - evita ciertas reentradas en contexto de serrucho / exceso bajista
    """
...
def senal_salida(
    ...
    """
    Replica la logica de salida SHORT:
    - trailing stop short
    - perdida de senal short base
    """
